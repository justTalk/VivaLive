...
public class BaseCallProxy {
    ...
    public static class Builder<T> {
        ...
        Activity mActivity;
        Flowable<DataWrapper<T>> mFlowable;
        ...
        private Builder<T> setFlowable(final Flowable<DataWrapper<T>> flowable) {
            mFlowable = flowable;
            return this;
        }
         ...
         * @return this
         */
        public static <T> Builder<T> newInstance(Flowable<DataWrapper<T>> flowable,
    ...
    private static <T> void doSubscribe(Activity activity,
                                        Flowable<DataWrapper<T>> observable,
        ...
        observable.observeOn(AndroidSchedulers.mainThread())
                .lift(new OperatorBindActivity<DataWrapper<T>>(activity))
